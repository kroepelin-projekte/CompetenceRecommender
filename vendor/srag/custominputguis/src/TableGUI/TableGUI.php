...
namespace srag\CustomInputGUIs\CompetenceRecommender\TableGUI;

use ilCSVWriter;
use ilExcel;
use ilFormPropertyGUI;
use ilTable2GUI;
use srag\CustomInputGUIs\CompetenceRecommender\PropertyFormGUI\Items\Items;
use srag\CustomInputGUIs\CompetenceRecommender\PropertyFormGUI\PropertyFormGUI;
use srag\CustomInputGUIs\CompetenceRecommender\TableGUI\Exception\TableGUIException;
use srag\DIC\CompetenceRecommender\DICTrait;

/**
 * Class TableGUI
 *
 * @package srag\CustomInputGUIs\CompetenceRecommender\TableGUI
 *
