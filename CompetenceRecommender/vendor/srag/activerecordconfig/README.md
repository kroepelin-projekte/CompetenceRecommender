...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\CompetenceRecommender\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\CompetenceRecommender\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\CompetenceRecommender\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
