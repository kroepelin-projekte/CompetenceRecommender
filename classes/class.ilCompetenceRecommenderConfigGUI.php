...
class ilCompetenceRecommenderConfigGUI extends ilPluginConfigGUI
{
    ...
    {
        $this->tpl->addJavascript("public/Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/CompetenceRecommender/templates/ProfileSelector.js");
        ...
        $table = new ilCompetenceRecommenderConfigTable($this, $tabledata);
